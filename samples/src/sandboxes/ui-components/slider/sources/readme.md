...
The purpose of this sample is to show off the different styles of sliders that are available to you when constructing iTwin.js applications.
...
Sliders are yet another great way to receive user input. They are great for quickly and easily getting numeric input across a set range.
