...
import {
  GraphicBranch, IModelApp, IModelConnection, readElementGraphics, RenderGraphic, RenderSystem, SceneContext, Tile, TileContent, TileDrawArgParams, TileDrawArgs, TileLoadPriority, TileRequest, TileRequestChannel, TileTree, TileTreeOwner,
  TileTreeReference, TileTreeSupplier, Viewport
...
class ElementTile extends Tile {
  ...
  /** Joins the ranges of the transformed by the minimum and maximum explode scaling. */
...
export class ExplodedGraphicsTile extends Tile {
  ...
  public async readContent(data: TileRequest.ResponseData, _system: RenderSystem, isCanceled?: () => boolean): Promise<TileContent> {
    ...
    // When for next iTwin.js update, the API will include an argument for batching options.  This should be set to the contentId.
