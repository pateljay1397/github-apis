...
import { imageElementFromUrl, IModelApp, TextureImage, Viewport } from "@itwin/core-frontend";
import { Point2d, Range1d, Range2d } from "@itwin/core-geometry";
import rainImg from "./particle_rain.png";
import rain1Img from "./particle_rain1.png";
import rain2Img from "./particle_rain2.png";
import rain3Img from "./particle_rain3.png";
import rain4Img from "./particle_rain4.png";
import rain5Img from "./particle_rain5.png";
import snowImg from "./particle_snow.png";
...
export default class SnowDecorationApi {
  ...
  public static async allocateTextureFromUrl(url: string): Promise<RenderTexture | undefined> {
    ...
    const image: TextureImage = { source: textureImage, transparency: TextureTransparency.Translucent };
    return IModelApp.renderSystem.createTexture({ type: RenderTexture.Type.Normal, image, ownership: "external" });
  }
