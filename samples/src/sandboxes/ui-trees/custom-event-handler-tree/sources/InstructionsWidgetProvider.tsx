...
export const InstructionsWidget = () => {
  return (
    <Alert type="informational" style={{ margin: "16px" }}>
      This tree demonstrates the interaction between tree node selection and checkbox selection.
      Selecting a tree node checks the corresponding checkbox, and deselects all other checkboxes
    </Alert >
  );
};
